...
from scr.database.models import User, Role
from scr.services.auth import auth_service
from scr.schemas import CommentBase, CommentResponse
from scr.repository import comments as repository_comments
from scr.conf import messages
from scr.services.roles import RoleAccess


router = APIRouter(prefix="/comments/{image_id}", tags=["Comments by image"])
