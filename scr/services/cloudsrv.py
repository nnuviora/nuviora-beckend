...
from scr.conf.config import config  # setting
...
class CloudinaryService:
    ...
    @staticmethod
    def generate_public_id_by_email(email: str, app_name: str = config.CLD_NAME) -> str:
        try:
        ...
        try:
            async with aiohttp.ClientSession() as session:
                ...
                async with session.post(
                        f"https://api.cloudinary.com/v1_1/{config.CLD_NAME}/upload",
